<div id="frmRegister" class="registerForm">
    <form action="../WebServices/registration.php">
        <div>
            ...
            <span style="position: relative; top: 15px;">Already A Member?</span><a href="#" id="loginBtnRegister" style="position: relative; top: 15px;">Log In</a>
        </div>
    </form>
</div>